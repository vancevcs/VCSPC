...
const char *KernelErrorToString(u32 err) {
	...
	case SCE_ERROR_AV_MODULE_ALREADY_LOADED: return "AV_MODULE_ALREADY_LOADED";
	case SCE_ERROR_AV_MODULE_NOT_LOADED: return "AV_MODULE_NOT_LOADED";
	...
	case SCE_ERROR_UTILITY_STRING_TOO_LONG:    return "UTILITY_STRING_TOO_LONG";
